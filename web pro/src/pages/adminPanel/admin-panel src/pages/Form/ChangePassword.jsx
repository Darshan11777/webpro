...
//   const [confirmPassword, setConfirmPassword] = useState('');
  ...
  // console.log( "response.data",response.data);
        ...
        err.response.data.extraDetails ||  setMessage(err.response ? err.response?.data : 'An error occurred');
        err.response.data.extraDetails && setMessage(err.response.data.extraDetails[0])
        console.log( "err",err.response.data.extraDetails);
      }
